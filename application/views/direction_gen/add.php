    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Direction Gen Add</h3>
            </div>
            <?php echo form_open('direction_gen/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="DATE_SIGNATURE" value="<?php echo $this->input->post('DATE_SIGNATURE'); ?>" class="has-datetimepicker form-control" id="DATE_SIGNATURE" />
						</div>
					</div>
					<div class="col-md-6">
